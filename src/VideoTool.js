		...
		if(submitted)
			...
			panelContent = (<div>
											<div className="pb-3 clearfix" style={{minWidth: "400px"}}>
												<Button disabled={adding} color="primary" size ="lg" onClick={this.handleAddClick} className="d-flex align-items-center float-left"><MdAdd/> {adding ? 'Adding Annotation' : 'New Annotation'}</Button>
